...
This package also installs an `owpenbot` binary as a convenience alias.
...
- Config stored at `~/.openwork/owpenbot/owpenbot.json` (created by `opencode-router` or `opencode-router setup`).
